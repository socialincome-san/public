  ...
  render: () => (
    <div className="space-y-8">
      <Typography lineHeight="none" className="bg-muted/20">
        Line Height None - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
      </Typography>
      <Typography lineHeight="tight" className="bg-muted/20">
        Line Height Tight - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
      </Typography>
      <Typography lineHeight="snug" className="bg-muted/20">
        Line Height Snug - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
      </Typography>
      <Typography lineHeight="normal" className="bg-muted/20">
        Line Height Normal - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
      </Typography>
      <Typography lineHeight="relaxed" className="bg-muted/20">
        Line Height Relaxed - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
      </Typography>
      <Typography lineHeight="loose" className="bg-muted/20">
        Line Height Loose - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
      </Typography>
    </div>
  ),
};
  ...
  render: () => (
    <div className="space-y-4">
      ...
      <Typography size="md" color="muted-foreground" lineHeight="relaxed">
        Muted body text with relaxed line height. Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
