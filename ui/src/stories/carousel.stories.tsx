      ...
      <CarouselContent>
        <div className="p-1">
          <div className="bg-primary-muted flex aspect-square items-center justify-center rounded-lg p-6">
            <span className="text-4xl font-semibold text-primary-foreground">Custom 1</span>
          </div>
        </div>
      </CarouselContent>
      <CarouselContent>
        <div className="p-1">
          <div className="bg-secondary-muted flex aspect-square items-center justify-center rounded-lg p-6">
            <span className="text-4xl font-semibold text-secondary-foreground">Custom 2</span>
          </div>
        </div>
      </CarouselContent>
      <CarouselContent>
        <div className="p-1">
          <div className="bg-accent-muted flex aspect-square items-center justify-center rounded-lg p-6">
            <span className="text-4xl font-semibold text-accent-foreground">Custom 3</span>
          </div>
        </div>
      </CarouselContent>
    </Carousel>
