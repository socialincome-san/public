...
export const CustomStyled: Story = {
	render: () => (
		<div className="flex flex-col space-y-4">
			<Input className="border-primary bg-primary/5 placeholder:text-primary/50" placeholder="Primary styled" />
			<Input className="border-secondary bg-secondary/5 placeholder:text-secondary/50" placeholder="Secondary styled" />
			<Input className="rounded-full border-2" placeholder="Custom border" />
		</div>
	),
};
...
export const WithButton: Story = {
	render: () => (
		<div className="flex space-x-2">
			...
			<button className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-xl px-4 py-2">Subscribe</button>
		</div>
	),
};
