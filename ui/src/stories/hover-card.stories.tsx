			...
			<HoverCard>
				...
				<HoverCardContent>
					<div className="flex flex-col gap-2">
						...
						<p className="text-sm">Frontend developer and UI designer. Love creating beautiful user interfaces.</p>
					</div>
				</HoverCardContent>
			</HoverCard>
		</div>
			...
			<HoverCard>
				...
				<HoverCardContent className="bg-primary text-primary-foreground w-72">
					<div className="space-y-2">
						...
						<p className="text-sm opacity-90">This hover card has custom background and text colors.</p>
					</div>
				</HoverCardContent>
			</HoverCard>
		</div>
				...
				<HoverCardContent className="w-80">
					<div className="space-y-4">
						<div className="space-y-2">
							...
							<p className="text-muted-foreground text-sm">This card contains interactive elements.</p>
						</div>
