import { ArrowRightIcon, ChevronRightIcon, PlusIcon, TrashIcon } from '@heroicons/react/24/outline';
...
export const Loading: Story = {
	render: () => (
		<div className="flex flex-wrap gap-4">
			...
			<Button variant="secondary" showLoadingSpinner>
				Loading Secondary
			</Button>
			<Button variant="outline" showLoadingSpinner>
				Loading Outline
			</Button>
		</div>
	),
