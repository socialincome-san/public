...
export function QuotedText({ text, author, authorTitle }: { text: string; author: string; authorTitle?: string }) {
	return (
		<div className="w-full px-0 py-14">
			<Typography className="m-0! p-0 leading-snug" weight="semibold" color="foreground" size="3xl">
				« {text} »
			</Typography>
			<div className="mt-4">
				<Typography color="foreground" size="md" weight="semibold" className="m-0! p-0">
					{author}
				</Typography>
				{authorTitle && (
