...
export const sendMessagesFunction = functions.https.onCall(
	async (
		{ targetAudience, messageRecipients, contentType, messageTemplate, freeTextContent }: SendUserMessagesFunctionProps,
		{ auth }
	) => {
...
export const sendTemplateUserMessage = (
	targetAudience: string,
...
export const sendTwilioSMS = async (
	...
	await addMessageInboxItem(targetAudience, messageRecipientId, {
