...
export const config = {
	matcher: [
		...
		'/((?!api|_next/static|_next/image|assets|data|fonts|favicon.ico|sw.js|portal|partner-space|storybook|v1/api-docs|openapi.json|sitemap.xml|robots.txt|llms.txt).*)',
	],
};
