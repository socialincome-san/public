...
import type { StoryblokAsset, StoryblokMultilink, StoryblokRichTextDoc, StoryblokMultiasset } from '../storyblok.d.ts';
...
export interface Article {
  ...
  footnotes?: StoryblokRichTextDoc;
  component: "article";
  _uid: string;
  _editable?: string | undefined;
  [k: string]: unknown;
...
export interface ModalCard {
  heading: string;
  image: StoryblokAsset;
  modalContent?: StoryblokRichTextDoc;
  component: "modalCard";
  _uid: string;
  _editable?: string | undefined;
  [k: string]: unknown;
...
export interface PartnershipsCard {
  title: string;
  description?: string;
  partnerships?: (ISbStoryData<Partnership> | string)[];
  component: "partnershipsCard";
  _uid: string;
  _editable?: string | undefined;
  [k: string]: unknown;
}
...
export interface TwoColumnText {
  leftText: StoryblokRichTextDoc;
  rightText: StoryblokRichTextDoc;
