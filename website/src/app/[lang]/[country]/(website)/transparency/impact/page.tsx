    ...
    <div className="bg-yellow-50">
      <BaseContainer className="flex flex-col items-center space-y-12 py-8 min-h-screen">
        ...
        <div className="pt-8 group">
          <a href="https://github.com/socialincome-san/public/issues/550" target="_blank" rel="noopener noreferrer" className="group flex items-center pl-3 pr-3 py-3 bg-black bg-opacity-5 hover:bg-black focus:outline-none focus:ring-4 focus:ring-primary font-medium rounded-full text-base text-black/80 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-dark hover:bg-opacity-10">
            <img src="https://avatars.githubusercontent.com/u/9919?v=4" className="w-12 h-12 rounded-full mr-4 group-hover:scale-110 transition-transform duration-300" alt="Avatar" />
            <span className="text-xl text-black/75 pl-3 pr-6">{translator.t('issue-unassigned')}</span>
          </a>
