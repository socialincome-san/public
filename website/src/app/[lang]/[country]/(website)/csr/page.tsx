  ...
  return (
    <div className="bg-yellow-50">
      <BaseContainer className="flex flex-col items-center space-y-12 py-8 min-h-screen">
        ...
        <div className="pt-4">
        <a href="https://github.com/anthonyray" target="_blank" rel="noopener noreferrer" className="group flex items-center pl-2 pr-2 py-2 bg-black bg-opacity-5 hover:bg-black focus:outline-none focus:ring-4 focus:ring-primary font-medium rounded-full text-base text-black/80 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-dark hover:bg-opacity-10">
                  <img src="https://avatars.githubusercontent.com/u/3779257?v=4" className="w-10 h-10 rounded-full mr-2 group-hover:scale-110 transition-transform duration-300" alt="Avatar" />
                  <span className="text-lg text-black/75 pl-3 pr-6">anthonyray {translator.t('issue-assigned')}</span>
                </a>
        </div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 space-y-12 w-full px-6 sm:px-4">
          ...
          <div className="flex justify-center space-x-4">
            ...
            {/* Button 2 */}
            <a href="https://www.figma.com/proto/qGO3YI21AWIjWEyMPGUczM/Website-Social?type=design&node-id=376-2473&viewport=2567%2C-513%2C0.45&t=jG5pilvATJ4817xv-0&scaling=contain&starting-point-node-id=143%3A29044" className="inline-flex items-center justify-center p-5 text-base font-medium text-black/75 rounded-lg hover:text-gray-900 transition-opacity duration-300 hover:bg-black hover:bg-opacity-5 hover:text-black/100" target="_blank">
