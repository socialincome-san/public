  ...
  return (
    <div className="bg-yellow-50">
      <BaseContainer className="flex flex-col items-center space-y-12 py-8 min-h-screen">
        ...
        <a href="https://github.com/anthonyray" target="_blank" rel="noopener noreferrer" className="group flex items-center pl-3 pr-3 py-3 bg-black bg-opacity-5 hover:bg-black focus:outline-none focus:ring-4 focus:ring-primary font-medium rounded-full text-base text-black/80 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-dark hover:bg-opacity-10">
                  <img src="https://avatars.githubusercontent.com/u/3779257?v=4" className="w-12 h-12 rounded-full mr-4 group-hover:scale-110 transition-transform duration-300" alt="Avatar" />
                  <span className="text-xl text-black/75 pl-3 pr-6">anthonyray {translator.t('issue-assigned')}</span>
                </a>
          <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-500 text-center mt-4 invisible group-hover:visible">
            <a href="https://github.com/socialincome-san/public/issues/550" target="_blank" rel="noopener noreferrer" className="underline">{translator.t('issue-collab')}
            </a>
          </div>
        </div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 space-y-12 w-full">
          ...
          <div className="flex justify-center space-x-4">
            ...
            {/* Button 1 */}
            <a href="https://github.com/socialincome-san/public/issues/550" className="inline-flex items-center justify-center p-5 text-base font-medium text-black/75 rounded-lg hover:text-gray-900 transition-opacity duration-300 hover:bg-black hover:bg-opacity-5 hover:text-black/100">
