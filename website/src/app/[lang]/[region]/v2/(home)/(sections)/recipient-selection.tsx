...
export async function RecipientSelection({ lang, region }: DefaultParams) {
	...
	return (
		<BaseContainer className="bg-primary pt-16 text-white">
			<div className="align-center flex flex-col justify-center text-center">
				...
				<ol className="m-8 flex list-decimal flex-row gap-x-10 text-justify">
					<li className="mx-4">
						<Typography size="sm">{translator.t('section-8.text-1.1')}</Typography>
					</li>
					<li className="mx-4">
						<Typography size="sm">{translator.t('section-8.text-1.2')}</Typography>
					</li>
				</ol>
			</div>
		</BaseContainer>
