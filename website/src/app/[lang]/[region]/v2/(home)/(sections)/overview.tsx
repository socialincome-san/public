...
export async function Overview({ lang, region }: DefaultParams) {
	...
	return (
		<BaseContainer className="mb-16 md:mb-48 flex flex-col items-center justify-center">
			<Typography size="3xl" weight="medium" color="foreground-dark" className="my-10 w-full md:w-3/5 text-center">
			...
			<Typography size="3xl" weight="medium" color="foreground-dark" className="mb-5 mt-12 w-full md:w-3/5 text-center">
