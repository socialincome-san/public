			...
			<Form {...form}>
				<form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col">
						...
						render={({ field }) => (
							<FormItem className="flex-1 sm:basis-2/3">
								<FormControl>
									...
									>
										<ToggleGroupItem className="text-md m-1 rounded-full" value={DonationInterval.OneTime}>
											{translations.oneTime}
										</ToggleGroupItem>
										<ToggleGroupItem className="text-md m-1 rounded-full" value={DonationInterval.Monthly}>
					...
					<Button
						...
						className="bg-accent text-foreground hover:bg-accent-muted active:bg-accent-muted rounded-full text-lg font-medium"
					>
						{translations.submit}
					</Button>
				</form>
