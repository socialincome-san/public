...
const Box = ({ active, number, title, subtitle, onClick }: BoxProps) => {
  return (
    <button
      onClick={onClick}
      className={classNames('group flex cursor-pointer items-center gap-4 rounded-lg border-2 border-primary p-4', {
        'bg-primary': active,
        'hover:bg-primary hover:text-popover-foreground': !active,
      })}
    >
      <div
        className={classNames('flex h-8 w-8 items-center justify-center rounded-full bg-primary bg-opacity-10 text-lg', {
          'bg-white bg-opacity-100 text-primary': active,
      ...
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
        ...
        <div className="space-y-16">
          <div id="preselection-section" ref={ref} className="scroll-mt-36">
            ...
            <div>
              <Typography weight="medium" className="mb-2 text-xl text-accent">
