...
export default async function Page({ params }: DefaultPageProps) {
	...
	return (
		<div className="bg-blue-50">
			<BaseContainer className="flex min-h-screen flex-col items-center space-y-12 py-8">
				...
				<div className="pt-4">
					<a
						...
						className="focus:ring-primary dark:hover:bg-dark group mb-2 mr-2 flex items-center rounded-full bg-black bg-opacity-5 py-2 pl-2 pr-2 text-center text-base font-medium text-black/80 hover:bg-black hover:bg-opacity-10 focus:outline-none focus:ring-4 dark:bg-blue-600"
					>
						<img
							src="https://avatars.githubusercontent.com/u/3779257?v=4"
							className="mr-2 h-10 w-10 rounded-full transition-transform duration-300 group-hover:scale-110"
							alt="Avatar"
						/>
						<span className="pl-3 pr-6 text-lg text-black/75">anthonyray {translator.t('issue-assigned')}</span>
					</a>
				</div>
				<div className="absolute left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2 transform space-y-12 px-6 sm:px-4">
					<Typography as="h1" size="5xl" weight="bold" className="text mx-auto text-center">
						{translator.t('title')}
					</Typography>
					<Typography as="h2" size="3xl" lineHeight="snug" className="text mx-auto max-w-3xl text-center">
					...
					<div className="flex justify-center space-x-4">
						...
						<a
							...
							className="inline-flex items-center justify-center rounded-lg p-5 text-base font-medium text-black/75 transition-opacity duration-300 hover:bg-black hover:bg-opacity-5 hover:text-black/100 hover:text-gray-900"
							target="_blank"
						>
							<svg
								aria-hidden="true"
							...
							>
								<path
									fill-rule="evenodd"
									d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.69-.01-1.35-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.66-.89-3.66-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.03 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.88 3.74-3.68 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38 3.18-1.06 5.47-4.05 5.47-7.59 0-4.42-3.58-8-8-8z"
								/>
							</svg>
