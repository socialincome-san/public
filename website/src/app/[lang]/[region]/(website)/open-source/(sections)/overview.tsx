...
const OverviewCard = ({ title, total, time }: OverviewProp) => {
  return (
    <Card className="rounded-lg border-2 border-opacity-80 bg-background px-2 py-5 shadow-none hover:bg-primary hover:bg-opacity-10 md:px-5 md:py-5">
      ...
      <div className="flex flex-col items-center md:hidden">
        ...
        <Typography as="span" size="md" className="text-center text-card-foreground-muted">
          {time}
        </Typography>
      </div>
    </Card>
