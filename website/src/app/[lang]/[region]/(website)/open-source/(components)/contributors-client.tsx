  ...
  return (
    <article className="flex min-w-60 flex-row items-center py-2">
      ...
      <div className="ml-4 flex flex-col items-start">
        ...
        <Typography as="span" size="md" className="mt-1 text-card-foreground-muted">
    ...
    <section className="flex flex-col justify-self-start">
      ...
      {!showAllContributors && totalContributors > 16 && (
        <div className="mt-12 flex justify-center">
          <Button variant="link" onClick={() => setShowAllContributors(true)} className="mr-20 text-xl text-card-foreground">
