    ...
    <div>
      ...
      <div className="grid w-full max-w-7xl grid-cols-1 justify-items-center gap-6 md:grid-cols-3">
        ...
        <Dialog>
          ...
          <DialogContent className="h-[70vh] w-full max-w-6xl overflow-y-auto rounded-3xl border-none bg-background p-6">
            <DialogHeader>
              <DialogTitle>
        ...
        <Dialog>
          ...
          <DialogContent className="flex h-[40vh] w-11/12 flex-col rounded-3xl border-none bg-background p-0 sm:min-w-[500px] md:min-w-[650px]">
