  ...
  return (
    <Dialog>
      <DialogTrigger className="text-left">
        <Card className="max-w-lg rounded-lg p-6 shadow-none hover:bg-primary hover:bg-opacity-10">
          ...
          <Separator className="mt-4 bg-primary bg-opacity-30" />
      ...
      <DialogContent className="h-[90vh] w-11/12 overflow-y-auto rounded-3xl border-none bg-background p-0 sm:min-w-[600px] md:min-w-[750px]">
        <DialogHeader className="relative -top-4">
          ...
          <div className="absolute bottom-0 left-0 h-32 w-full bg-gradient-to-t from-black to-transparent">
            <DialogTitle className="absolute bottom-0 left-0 px-8 py-4 text-accent">
        ...
        <div className="px-8 pb-10">
          <div className="flex flex-col gap-2 p-0 pb-8 pt-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:justify-start">
              <Badge className="space-x-2 bg-primary bg-opacity-10 px-4 py-2 text-primary hover:bg-primary hover:bg-opacity-100 hover:text-white">
                {countryBadge?.countryFlagComponent || <SL_flag className="h-5 w-5 rounded-full" />}
          ...
          {showFundRaiser && (
            <div className="mb-8 flex items-center justify-start space-x-5 rounded-md border-2 border-primary border-opacity-80 py-4 pl-4">
          ...
          <Separator className="my-6 bg-primary bg-opacity-10" />
