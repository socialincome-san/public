...
export async function Hero({ lang }: DefaultParams) {
	...
	return (
		<BaseContainer className="mx-auto mb-8 mt-20 flex w-4/5 flex-col items-center justify-center md:mb-20 lg:w-3/5">
			...
			<Typography className="mb-8">{translator.t('hero.subtitle')}</Typography>
		</BaseContainer>
	);
}
