    ...
    <>
      ...
      >
        <div className="flex flex-row space-x-2">
          ...
          >
            {playing ? (
              <PauseIcon className="h-6 w-6 text-muted-foreground" />
            ) : (
          ...
          >
            {muted ? (
              <SpeakerXMarkIcon className="h-6 w-6 text-muted-foreground" />
            ) : (
              <SpeakerWaveIcon className="h-6 w-6 text-muted-foreground" />
            )}
          </Button>
        </div>
      </div>
