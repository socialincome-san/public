  ...
  return (
    ...
    >
      ...
      <div className="mx-auto -mb-6 flex w-4/5 max-w-xl pt-20 text-center text-xl text-white md:pt-40 md:text-2xl">
        <div className="flex h-72 flex-1 -rotate-6 flex-col items-center justify-between bg-primary py-4 md:h-96">
          <div />
        ...
        <div className="-ml-6 mt-12 flex h-72 flex-1 rotate-2 flex-col items-center justify-between bg-accent py-4 md:h-96">
          <div />
          <Typography weight="medium" className="w-3/4">
