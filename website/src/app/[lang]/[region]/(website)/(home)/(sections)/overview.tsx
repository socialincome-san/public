...
export const Overview = async ({ lang }: DefaultParams) => {
	...
	return (
		<BaseContainer className="mx-auto mt-8 mb-16 flex w-4/5 flex-col items-center justify-center md:mt-16 md:mb-48 lg:w-3/5">
			...
			<Typography size="3xl" weight="medium" className="mt-12 mb-5 text-center">
