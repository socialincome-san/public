...
export default async function CountriesOverviewRoute({ params }: DefaultPageProps) {
	...
	const overviewResult = await services.storyblok.getStoryWithFallback<ISbStoryData<CountryOverview>>(
	...
	return (
		<CountriesOverviewPage overview={overviewResult.data} lang={lang as WebsiteLanguage} region={region as WebsiteRegion} />
	);
}
