...
const LIVING_LOCATION: Question = {
	type: QuestionInputType.RADIO_GROUP,
...
const NUMBER_OF_DEPENDENTS: Question = {
	type: QuestionInputType.RADIO_GROUP,
	name: 'nrDependentsV1',
...
const SCHOOL_ATTENDANCE: Question = {
	type: QuestionInputType.RADIO_GROUP,
...
const SKIPPING_MEALS_LAST_WEEK_3_MEALS: Question = {
	type: QuestionInputType.RADIO_GROUP,
...
const UNEXPECTED_EXPENSES_COVERED: Question = {
	type: QuestionInputType.RADIO_GROUP,
...
const PLANNED_ACHIEVEMENT: Question = {
...
const ACHIEVEMENTS_NOT_ACHIEVED: Question = {
	type: QuestionInputType.COMMENT,
