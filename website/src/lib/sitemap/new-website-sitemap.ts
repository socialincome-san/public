...
export const NEW_WEBSITE_SITEMAP_PATH = `/${NEW_WEBSITE_SLUG}/sitemap.xml`;
...
export const generateNewWebsiteSitemap = async (): Promise<MetadataRoute.Sitemap> => {
