...
export const WebsiteAppShell = ({ children, session, lang, region, scope }: WebsiteAppShellProps) => {
  return (
    <div className="theme-new flex min-h-screen w-full flex-col bg-gradient-to-br from-[hsl(var(--gradient-background-from))] to-[hsl(var(--gradient-background-to))] bg-fixed text-primary antialiased">
