...
export const Footer = async ({ lang, region }: Props) => {
	...
	return (
		<div className="bg-primary container mx-auto mb-10 grid grid-cols-1 gap-4 rounded-3xl px-8 pt-10 pb-8 text-white sm:px-16 sm:pt-14 lg:grid-cols-[334px_auto]">
			<div>
