        ...
        <DialogContent>
          ...
          {status === 'idle' && (
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleSend)} className="mt-4 space-y-4">
                ...
                <p className="text-center text-xs text-muted-foreground">We’ll send you a magic link to sign in.</p>
              </form>
            </Form>
          )}
          ...
          {status === 'sent' && (
            <div className="mt-4 space-y-4 text-center">
              <p className="text-sm">
                If an account exists for <span className="font-medium">{submittedEmail}</span>, you’ll receive a login link
                shortly.
              </p>
