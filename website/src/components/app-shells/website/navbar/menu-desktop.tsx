...
export const MenuDesktop = ({ nav, lang, region }: Props) => (
  <NavigationMenu.Root>
            ...
            <NavigationMenu.Item key={item._uid}>
              <NavigationMenu.Link asChild className="group">
                <NextLink
                  ...
                  className="flex items-center rounded-sm px-3 py-2 text-sm font-semibold transition-colors hover:bg-muted"
                >
                  {item.label}
                </NextLink>
              </NavigationMenu.Link>
        ...
        return (
          <NavigationMenu.Item key={item._uid}>
            <NavigationMenu.Trigger
              className={cn(
                'group flex items-center gap-1.5 rounded-sm px-3 py-2 text-sm font-semibold transition-colors hover:bg-muted',
            ...
            <NavigationMenu.Content className="rounded-3xl bg-muted p-8 shadow-[0_24px_48px_rgba(15,23,42,0.16)]">
                        ...
                        {group.items?.map((child) => (
                          <NavigationMenu.Link key={child._uid} asChild>
                            <NextLink
                              ...
                              className="group flex w-fit items-center gap-2 font-medium text-muted-foreground transition-colors hover:text-foreground"
                            >
    ...
    <NavigationMenu.Viewport className="w-2xl absolute inset-x-0 top-[calc(100%+1rem)] z-50 data-[state=closed]:animate-fade-out data-[state=open]:animate-enter-from-top" />
  </NavigationMenu.Root>
);
