		...
		<div className="relative aspect-square w-full max-w-104">
			<div className="absolute inset-0 flex items-start justify-start">
				<MapImage
					...
					containerClassName="relative h-full w-full overflow-hidden rounded-full border-4 border-primary-foreground shadow-[0_0_28px_rgba(0,0,0,0.1)]"
			...
			<div className="absolute right-[4%] bottom-[4%] aspect-square w-[28%] translate-x-[1%] translate-y-[1%]">
				<MapImage
					...
					containerClassName="relative h-full w-full overflow-hidden rounded-full border-4 border-primary-foreground bg-primary-foreground shadow-[0_0_22px_rgba(0,0,0,0.1)]"
					imageClassName="object-cover"
				/>
			</div>
		</div>
