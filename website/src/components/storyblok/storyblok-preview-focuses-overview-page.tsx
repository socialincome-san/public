...
export const StoryblokPreviewFocusesOverviewPage = async ({ storyPath, lang, previewRoutePath, searchParams }: Props) => {
	return await StoryblokPreviewStory<ISbStoryData<FocusOverview>>({
		...
		renderStory: (overview) => <FocusesOverviewPage overview={overview} searchParams={searchParams} />,
	});
};
