	...
	return (
		<div className="space-y-6">
			<div className="space-y-2">
				...
				<Slider data-testid="program-duration-slider" min={6} max={60} step={1} value={[programDuration]} onValueChange={([v]) => onDurationChange(v)} />
			</div>
			...
			<div className="space-y-2">
				...
				<Slider data-testid="payout-per-interval-slider" min={5} max={100} step={1} value={[payoutPerInterval]} onValueChange={([v]) => onPayoutChange(v)} />
			</div>
