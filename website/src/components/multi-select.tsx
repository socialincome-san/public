								...
								<div className="flex w-full items-center justify-between">
												...
												return (
													...
													>
														...
														<div
															...
															className="-m-0.5 ml-2 h-4 w-4 cursor-pointer rounded-sm p-0.5 hover:bg-white/20 focus:outline-hidden focus:ring-1 focus:ring-white/50"
														>
									...
									<div className="flex items-center justify-between">
										<div
											...
											className="text-muted-foreground hover:text-foreground focus:ring-ring mx-2 flex h-4 w-4 cursor-pointer items-center justify-center rounded-sm focus:outline-hidden focus:ring-2 focus:ring-offset-1"
										>
