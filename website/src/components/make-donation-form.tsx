...
export const MakeDonationForm = ({ lang }: Props) => {
  ...
  return (
    <div className="w-96 rounded-3xl border border-border bg-white p-9 text-foreground shadow-[0_2px_4px_rgba(0,0,0,0.05)]">
      <h3 className="mb-5 text-2xl font-semibold leading-none">{t('title')}</h3>

      <div className="mb-3 grid grid-cols-[70%_30%] overflow-hidden rounded-md border border-muted">
        <div className="border-r border-muted px-3 py-2">
      ...
      <div className="mb-4 grid grid-cols-4 divide-x divide-muted overflow-hidden rounded-xl border border-muted">
      ...
      <div className="mb-4 grid grid-cols-2 rounded-md bg-accent p-1">
        <button
          type="button"
