...
export const CampaignsOverview = async ({
	...
	const submissionLabels = {
		...
		linkInstagram: translator.t('campaigns-page.submission.link-instagram'),
		linkX: translator.t('campaigns-page.submission.link-x'),
		linkWebsite: translator.t('campaigns-page.submission.link-website'),
		linkTiktok: translator.t('campaigns-page.submission.link-tiktok'),
