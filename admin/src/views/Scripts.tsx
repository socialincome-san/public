                    ...
                    <Grid container rowSpacing={5} columnSpacing={2}>
                        ...
                        <Grid item xs={12} sm={4}>
                            <Card variant="outlined" sx={{
                                ...
                                <CardActions>
                                    <Button
                                        onClick={batchImportStripeCharges}
                                        color="primary">
                                ...
                                <CardContent sx={{flexGrow: 1}}>
                                    <Typography>
                                        New stripe payments are automatically added to firestore through a webhook.
                                        To sync existing ones one can use this batch import.
                                    </Typography>
                                </CardContent>
