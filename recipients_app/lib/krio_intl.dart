...
/// A custom set of date patterns for the `krio` locale.
///
...
/// A custom set of date symbols for the `krio` locale.
///
...
// #docregion Delegate
class _KrioMaterialLocalizationsDelegate
    extends LocalizationsDelegate<MaterialLocalizations> {
  const _KrioMaterialLocalizationsDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    ...
    // The locale (in this case `krio`) needs to be initialized into the custom
    // date symbols and patterns setup that Flutter uses.
    date_symbol_data_custom.initializeDateFormattingCustom(
      locale: localeName,
      patterns: krioLocaleDatePatterns,
      symbols: intl.DateSymbols.deserializeFromMap(krioDateSymbols),
    );

    return SynchronousFuture<MaterialLocalizations>(
      KrioMaterialLocalizations(
  ...
  @override
  bool shouldReload(_KrioMaterialLocalizationsDelegate old) => false;
}
// #enddocregion Delegate

// #docregion Delegate
class _KrioCupertinoLocalizationsDelegate
    extends LocalizationsDelegate<CupertinoLocalizations> {
  const _KrioCupertinoLocalizationsDelegate();
  ...
  @override
  bool shouldReload(_KrioCupertinoLocalizationsDelegate old) => false;
}
// #enddocregion Delegate

class KrioCupertinoLocalizations extends GlobalCupertinoLocalizations {
  const KrioCupertinoLocalizations({
  ...
  static const LocalizationsDelegate<CupertinoLocalizations> delegate =
      _KrioCupertinoLocalizationsDelegate();
...
/// A custom set of localizations for the 'krio' locale. In this example, only
/// the value for openAppDrawerTooltip was modified to use a custom message as
/// an example. Everything else uses the American English (en_US) messages
/// and formatting.
class KrioMaterialLocalizations extends GlobalMaterialLocalizations {
  const KrioMaterialLocalizations({
    super.localeName = "kri",
    required super.fullYearFormat,
...
// #enddocregion Raw
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate =
      _KrioMaterialLocalizationsDelegate();
