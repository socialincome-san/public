...
Survey _$SurveyFromJson(Map<String, dynamic> json) => Survey(
      ...
      dueDateAt: _$JsonConverterFromJson<Object, Timestamp>(
          json['due_date_at'], const TimestampConverter().fromJson),
      completedAt: _$JsonConverterFromJson<Object, Timestamp>(
          json['completed_at'], const TimestampConverter().fromJson),
...
Map<String, dynamic> _$SurveyToJson(Survey instance) => <String, dynamic>{
      ...
      'due_date_at': _$JsonConverterToJson<Object, Timestamp>(
          instance.dueDateAt, const TimestampConverter().toJson),
      'completed_at': _$JsonConverterToJson<Object, Timestamp>(
