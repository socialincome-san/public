...
SocialIncomePayment _$SocialIncomePaymentFromJson(Map<String, dynamic> json) => SocialIncomePayment(
  id: json['id'] as String? ?? '',
  amount: (json['amount'] as num?)?.toInt(),
  paymentAt: _$JsonConverterFromJson<Object, Timestamp>(json['payment_at'], const TimestampConverter().fromJson),
...
Map<String, dynamic> _$SocialIncomePaymentToJson(SocialIncomePayment instance) => <String, dynamic>{
  'amount': instance.amount,
  'payment_at': _$JsonConverterToJson<Object, Timestamp>(instance.paymentAt, const TimestampConverter().toJson),
