...
Recipient _$RecipientFromJson(Map<String, dynamic> json) => Recipient(
  ...
  communicationMobilePhone:
      json['communication_mobile_phone'] == null
          ? null
          : Phone.fromJson(json['communication_mobile_phone'] as Map<String, dynamic>),
  mobileMoneyPhone:
      json['mobile_money_phone'] == null ? null : Phone.fromJson(json['mobile_money_phone'] as Map<String, dynamic>),
  firstName: json['first_name'] as String?,
  lastName: json['last_name'] as String?,
  birthDate: _$JsonConverterFromJson<Object, Timestamp>(json['birth_date'], const TimestampConverter().fromJson),
  ...
  recipientSince: _$JsonConverterFromJson<String, DateTime>(
    json['recipient_since'],
    const DateTimeConverter().fromJson,
  ),
  imLinkInitial: json['im_link_initial'] as String?,
  imLinkRegular: json['im_link_regular'] as String?,
  nextSurvey: _$JsonConverterFromJson<Object, Timestamp>(json['next_survey'], const TimestampConverter().fromJson),
  organizationRef: _$JsonConverterFromJson<Object, DocumentReference<Object?>>(
    json['organisation'],
...
Map<String, dynamic> _$RecipientToJson(Recipient instance) => <String, dynamic>{
  ...
  'birth_date': _$JsonConverterToJson<Object, Timestamp>(instance.birthDate, const TimestampConverter().toJson),
  ...
  'recipient_since': _$JsonConverterToJson<String, DateTime>(instance.recipientSince, const DateTimeConverter().toJson),
  'im_link_initial': instance.imLinkInitial,
  'im_link_regular': instance.imLinkRegular,
  'next_survey': _$JsonConverterToJson<Object, Timestamp>(instance.nextSurvey, const TimestampConverter().toJson),
