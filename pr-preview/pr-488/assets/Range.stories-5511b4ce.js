import{a as i,F as I,j as a}from"./jsx-runtime-dd758c57.js";import{r as g}from"./index-5ac02154.js";import{c as C}from"./clsx.m-1229b3e0.js";import{t as E}from"./tw-merge-1166cefb.js";import"./_commonjsHelpers-725317a4.js";const d=g.forwardRef(({color:e,size:u,step:o,dataTheme:T,className:b,...m},j)=>{const q=E("range",b,C({"range-lg":u==="lg","range-md":u==="md","range-sm":u==="sm","range-xs":u==="xs","range-primary":e==="primary","range-secondary":e==="secondary","range-accent":e==="accent","range-info":e==="info","range-success":e==="success","range-warning":e==="warning","range-error":e==="error"})),F=s=>!isNaN(parseFloat(s))&&isFinite(s),M=g.useMemo(()=>{const s=Math.max(1,Number(o));return Math.ceil(100/s)??1},[m.max,o]);return i(I,{children:[a("input",{...m,ref:j,type:"range",step:o,"data-theme":T,className:q}),F(o)&&a("div",{className:"w-full flex justify-between text-xs px-2",children:[...Array(M+1)].map((s,D)=>a("span",{children:"|"},D))})]})});d.displayName="Range";const r=d;try{d.displayName="Range",d.__docgenInfo={description:"",displayName:"Range",props:{dataTheme:{defaultValue:null,description:"",name:"dataTheme",required:!1,type:{name:"string"}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"lg"'},{value:'"md"'},{value:'"sm"'},{value:'"xs"'}]}}}}}catch{}try{r.displayName="Range",r.__docgenInfo={description:"",displayName:"Range",props:{dataTheme:{defaultValue:null,description:"",name:"dataTheme",required:!1,type:{name:"string"}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"lg"'},{value:'"md"'},{value:'"sm"'},{value:'"xs"'}]}}}}}catch{}const B={title:"Data Input/Range",component:r},S=e=>a(r,{...e}),n=S.bind({});n.args={};const l=S.bind({});l.args={step:25};const t=e=>i("div",{className:"w-full flex flex-col gap-2",children:[a(r,{...e,defaultValue:"20",color:"primary"}),a(r,{...e,defaultValue:"30",color:"secondary"}),a(r,{...e,defaultValue:"40",color:"accent"}),a(r,{...e,defaultValue:"50",color:"success"}),a(r,{...e,defaultValue:"60",color:"warning"}),a(r,{...e,defaultValue:"70",color:"info"}),a(r,{...e,defaultValue:"80",color:"error"})]});t.args={};const c=e=>i("div",{className:"w-full flex flex-col gap-2",children:[a(r,{...e,defaultValue:"40",size:"xs"}),a(r,{...e,defaultValue:"50",size:"sm"}),a(r,{...e,defaultValue:"60",size:"md"}),a(r,{...e,defaultValue:"70",size:"lg"})]});var p,f,x;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`args => {
  return <Range {...args} />;
...
}`,...(z=(w=c.parameters)==null?void 0:w.docs)==null?void 0:z.source}}};const G=["Default","WithSteps","Colors","Sizes"];export{t as Colors,n as Default,c as Sizes,l as WithSteps,G as __namedExportsOrder,B as default};
//# sourceMappingURL=Range.stories-5511b4ce.js.map
